...
const GAME_INT BG_R = 157;
const GAME_INT BG_G = 159;
const GAME_INT BG_B = 200;
...
//Arrow
const GAME_INT ARROW_TIMER = 350;
const GAME_INT ARROW_TIMER_SPEED = 5;
...
//Blast
const GAME_INT BLAST_TIMER = 300;
const GAME_INT BLAST_TIMER_SPEED = 10;
...
//Components
enum COMPONENT_TYPE {
	SPRITE_COMPONENT, CIRCLE_COMPONENT, SLIDE_COMPONENT, INPUT_COMPONENT, TIMEDLIFE_COMPONENT, 
	ARROW_COMPONENT, BOMB_COMPONENT, BLAST_COMPONENT, SECRET_EXIT_COMPONENT
};

//Object Types
enum OBJECT_TYPE {
	DEFAULT_TYPE, ARROW_TYPE, BOMB_TYPE, BLAST_TYPE, LEEVER_TYPE, PLAYER_TYPE, OCTOROK_TYPE, ROCK_TYPE, EXIT_TYPE, DESTRUCTIBLE_TYPE,
	WALL_TYPE, SECRET_EXIT_TYPE
};
